...
<div class="w-[82%] h-[70vh] ml-auto grid grid-cols-3 gap-4">
    <%
    ArrayList<ProductModel> products = (ArrayList<ProductModel>) session.getAttribute("cart");
    if (products != null) {
        int counter = 1; // Initializing the counter
        for (ProductModel product : products) {
    %>
    <div
        class="bg-white p-4 border flex flex-col justify-between border-gray-300 shadow-lg rounded-xl">
        <div>
