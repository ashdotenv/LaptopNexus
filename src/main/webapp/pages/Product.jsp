		...
		<div
			...
			<div>
				<div class="flex gap-2">
					<img alt=""
					 class="h-[300px] hover:scale-2"	src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcScPdsC0S6PwDKC2Vz3ILck4OE-Pun5uF_Lz_sWuAl4Lg&s">
					<div class="*:mt-2 *:w-20">
						<img class=" h-12" alt=""
							src="https://miro.medium.com/v2/resize:fit:1200/1*0HIdwBOPpG4d5sPqw6EA8Q.jpeg">

						<img class="h-[100px]" alt=""
